...
function getRestrictionStringByCid($cid){
    $sql="select restriction from Course where cid='".$cid."'";
    $result=mysql_query($sql);
    return mysql_fetch_array($result)[0];
}
function transRestrictionToCNF($restriction){
    $stack=analysis($restriction);
    return $stack[0];
}
