    ...
    <form action="displayStudentOwnPlan.php" method="get">
        <div class="planner" style="font-size:20px;font-style:oblique;">
            ...
            <div id="checkbox" style="position:absolute;top:170px; left:430px;">
                <label>
                    <input type="radio" name="term2" value="0" id="RadioGroup1_0">
                    SPRING</label>
                <br>
<!--                <label>-->
...
<!--                <br>-->
                <label>
                    <input type="radio" name="term2" value="1" id="RadioGroup1_2">
                    FALL</label>
                <br>
<!--                <label>-->
...
<!--                <br>-->
        ...
        <br>
        <br>
        <div style="position:absolute;top:240px; left:430px;">
            <center>
