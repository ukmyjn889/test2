        ...
        function showCNF(prerequisites){
            ...
            xhttp.onreadystatechange = function() {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    document.getElementById("pid").title.innerHTML = xhttp.responseText;
                }
            }
                        ...
                        <div align="left">
                            <table width="583" border="0" align="center">
                                ...
                                <tr>
                                    ...
                                    <td> <textarea rows="2" cols="45" name="prerequisites" id="pid" readonly onmouseover="showCNF(document.getElementById('pid').value)" title=""></textarea><br><input type="button" onclick="clearP()" value="clear"">
                                        <input type="button" value="check" onclick=""><input type="button" value="showCNF" onclick="showCNF(document.getElementById('pid').value)"><br/>
